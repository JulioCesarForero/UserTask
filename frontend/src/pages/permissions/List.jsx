...
import PermissionsAddPage from 'pages/permissions/Add';
...
const PermissionsListPage = (componentProps) => {
	...
	function ImportData() {
		if (props.importData) {
			return (
				<ImportPageData label="Select a file to import" uploadPath="permissions/importdata" buttonIcon="pi pi-folder" buttonLabel="Import Data" onImportCompleted={(response) => {app.flashMsg('Import Data', response, 'success')}} />
			);
		}
	}
        ...
        <div className="container-fluid">
            <div className="flex flex-wrap gap-4 items-center gap-4">
                ...
                <div className="col-span-full " >
                    <Title title="Permissions"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-gray-500"      separator={false} />
                </div>
            </div>
        </div>
        <hr />
    ...
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="flex flex-wrap justify-between items-center gap-3">
                <div className="col-span-full " >
                    <CanView pagePath="permissions/add">
                        <Button label="Add Permission" icon="pi pi-plus"  onClick={()=>app.openPageDialog(<PermissionsAddPage isSubPage apiPath={`/permissions/add`} />, { closeBtn: true  })}  className="p-button w-full bg-primary "  />
                    </CanView>
                </div>
                <div className="col-span-full " >
                    <IconField>
