...
const defaultProps = {
	...
	apiPath: 'taskstatuses/add',
	routeName: 'taskstatusesadd',
...
const TaskstatusesAddPage = (componentProps) => {
	const props = {
		...defaultProps,
		...componentProps
	}
	...
	if(pageReady){
		return (
<main id="TaskstatusesAddPage" className="main-page">
    { (props.showHeader) && 
        ...
        <div className="container-fluid">
            <div className="flex flex-wrap gap-4 items-center gap-4">
                ...
                <div className="col-span-full " >
                    <Title title="Add Task Status"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-gray-500" iconClass="pi pi-plus" avatarSize="large"    separator={false} />
                </div>
            </div>
        </div>
        <hr />
...
export default TaskstatusesAddPage;
