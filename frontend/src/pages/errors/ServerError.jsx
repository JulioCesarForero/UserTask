...
const ServerError = (componentProps) => {
    const props = {
        ...defaultProps,
        ...componentProps
    }
    ...
    return (
        <div className="md:max-w-[40%] mx-auto card">
            <div className="flex flex-col gap-4 items-center">
                ...
                <div className="text-gray-600 font-bold text-lg">An error occurred while processing your request. Please contact the Administrator for more information</div>
                <Divider />
