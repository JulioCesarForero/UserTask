...
const defaultProps = {
	...
	apiPath: 'taskpriorities/index',
	routeName: 'taskprioritieslist',
...
const TaskprioritiesListPage = (componentProps) => {
	...
	function PriorityIdTemplate(data){
		if(data){
			return (
				<Link to={`/taskpriorities/view/${data.priority_id}`}> { data.priority_id }</Link>
	...
	function ImportData() {
		if (props.importData) {
			return (
				<ImportPageData label="Select a file to import" uploadPath="taskpriorities/importdata" buttonIcon="pi pi-folder" buttonLabel="Import Data" onImportCompleted={(response) => {app.flashMsg('Import Data', response, 'success')}} />
			);
		}
	}
	...
	return (
<main id="TaskprioritiesListPage" className="main-page">
    { (props.showHeader) && 
        ...
        <div className="container-fluid">
            <div className="flex flex-wrap gap-4 items-center gap-4">
                ...
                <div className="col-span-full " >
                    <Title title="Task Priorities"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-gray-500"      separator={false} />
                </div>
            </div>
        </div>
        <hr />
                    ...
                    <div >
                        ...
                        <div className="page-records">
                            <DataTable 
                                ...
                                <Column  field="priority_name" header="Priority Name"   ></Column>
...
export default TaskprioritiesListPage;
