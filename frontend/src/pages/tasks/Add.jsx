...
const TasksAddPage = (componentProps) => {
	const props = {
		...defaultProps,
		...componentProps
	}
	...
	if(pageReady){
		return (
<main id="TasksAddPage" className="main-page">
    { (props.showHeader) && 
        ...
        <div className="container-fluid">
            <div className="flex flex-wrap gap-4 items-center gap-4">
                ...
                <div className="col-span-full " >
                    <Title title="Add Task"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-gray-500" iconClass="pi pi-plus" avatarSize="large"    separator={false} />
                </div>
            </div>
        </div>
        <hr />
