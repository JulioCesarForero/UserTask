...
import RolesAddPage from 'pages/roles/Add';
...
const RolesListPage = (componentProps) => {
	...
	function ImportData() {
		if (props.importData) {
			return (
				<ImportPageData label="Select a file to import" uploadPath="roles/importdata" buttonIcon="pi pi-folder" buttonLabel="Import Data" onImportCompleted={(response) => {app.flashMsg('Import Data', response, 'success')}} />
			);
		}
	}
        ...
        <div className="container-fluid">
            <div className="flex flex-wrap gap-4 items-center gap-4">
                ...
                <div className="col-span-full " >
                    <Title title="Roles"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-gray-500"      separator={false} />
                </div>
            </div>
        </div>
        <hr />
    ...
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="flex flex-wrap justify-between items-center gap-3">
                <div className="col-span-full " >
                    <CanView pagePath="roles/add">
                        <Button label="Add Role" icon="pi pi-plus"  onClick={()=>app.openPageDialog(<RolesAddPage isSubPage apiPath={`/roles/add`} />, { closeBtn: true  })}  className="p-button w-full bg-primary "  />
                    </CanView>
                </div>
                <div className="col-span-full " >
                    <IconField>
