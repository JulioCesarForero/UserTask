...
import SysdiagramsEditPage from 'pages/sysdiagrams/Edit';
...
const defaultProps = {
	...
	apiPath: 'sysdiagrams/view',
	routeName: 'sysdiagramsview',
...
const SysdiagramsViewPage = (componentProps ) => {
	...
	function ActionButton(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog(<SysdiagramsEditPage isSubPage apiPath={`/sysdiagrams/edit/${data.diagram_id}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	if(pageReady){
		return (
			<div>
<main id="SysdiagramsViewPage" className="main-page">
    { (props.showHeader) && 
        ...
        <div className="container-fluid">
            <div className="flex flex-wrap gap-4 items-center gap-4">
                ...
                <div className="col-span-full " >
                    <Title title="Sysdiagram Details"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-gray-500" iconClass="pi pi-eye" avatarSize="large"    separator={false} />
                </div>
            </div>
        </div>
        <hr />
                    ...
                    <div >
                        ...
                        <div className="mb-3 grid grid-cols-12 gap-4">
                            ...
                            <div className="col-span-full md:col-span-4">
                                <div className="flex gap-2 items-center card p-3 nice-shadow-2">
                                    <div>
                                        <div className="text-gray-600 mb-1">Principal Id</div>
                                        <div className="font-bold">{ item.principal_id }</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-span-full md:col-span-4">
                                <div className="flex gap-2 items-center card p-3 nice-shadow-2">
                                    <div>
                                        <div className="text-gray-600 mb-1">Diagram Id</div>
                                        <div className="font-bold">{ item.diagram_id }</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-span-full md:col-span-4">
                            ...
                            <div className="col-span-full md:col-span-4">
                                <div className="flex gap-2 items-center card p-3 nice-shadow-2">
                                    <div>
                                        <div className="text-gray-600 mb-1">Definition</div>
                                        <div className="font-bold">{ item.definition }</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default SysdiagramsViewPage;
