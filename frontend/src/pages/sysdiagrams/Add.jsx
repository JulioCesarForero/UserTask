...
const defaultProps = {
	...
	apiPath: 'sysdiagrams/add',
	routeName: 'sysdiagramsadd',
...
const SysdiagramsAddPage = (componentProps) => {
	const props = {
		...defaultProps,
		...componentProps
	}
	...
	if(pageReady){
		return (
<main id="SysdiagramsAddPage" className="main-page">
    { (props.showHeader) && 
        ...
        <div className="container-fluid">
            <div className="flex flex-wrap gap-4 items-center gap-4">
                ...
                <div className="col-span-full " >
                    <Title title="Add Sysdiagram"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-gray-500" iconClass="pi pi-plus" avatarSize="large"    separator={false} />
                </div>
            </div>
        </div>
        <hr />
...
export default SysdiagramsAddPage;
